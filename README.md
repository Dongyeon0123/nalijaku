...
### 프로젝트명
**날리자쿠 (Nallijaku)** - 교육 플랫폼

### 프로젝트 설명
날리자쿠는 드론, AI, 창업, 환경 등 다양한 분야의 교육 콘텐츠를 제공하는 온라인 학습 플랫폼입니다. 학교 및 교육기관을 대상으로 맞춤형 교육 커리큘럼을 제공하며, 강사 관리, 학습자료 관리, 차시별 학습 콘텐츠 등을 통합 관리할 수 있는 시스템입니다.
